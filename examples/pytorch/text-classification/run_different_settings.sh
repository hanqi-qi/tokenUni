        ...
        do
            ...
            do
                ...
                do
                    ...
                    do
<<<<<<< HEAD
                        bash run_glue_no_trainer.sh $apply_exrank $lnv $TASK_NAME $model_name $decay_alpha $alpha_lr>"./outlog/0422_addglue${model_name}_${TASK_NAME}_${apply_exrank}_${lnv}.out" 2>&1
=======
