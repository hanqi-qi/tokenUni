...
for model in ["roberta-base","distilbert-base-uncased"]:#"albert-base-v1","roberta-base",
    for apply_exrank in ["_add_last_afterln","_add_last_beforeln"]:
        for decay_alpha in ["-0.2","-0.5","-0.8"]:
            for alpha_lr in ["2e-3","2e-5"]:
                cwd = "/home/hanq1warwick/tokenUni/examples/pytorch/token-classification/outlog"
