...
def apply_chunking_to_forward(
    forward_fn: Callable[..., torch.Tensor], i_layer: int, chunk_size: int, chunk_dim: int, *input_tensors,
) -> torch.Tensor:
    """
    ...
    #TODO(yhq): modify after adding "i_layer" as extra argument
    ...
    return forward_fn(*input_tensors,i_layer)
